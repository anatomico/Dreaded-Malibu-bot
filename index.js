...
const owner = process.env.DEV || '254743551416'; // This will send a notification once the bot reconnects
const {
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Follow me on GitHub as kanng7", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `Bot has started... [𝐃𝐑𝐄𝐀𝐃𝐄𝐃 𝐌𝐀𝐋𝐈𝐁𝐔 𝐁𝐎𝐓]` });
    }
